...
expName = 'Localization_IfspeechCrashes'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/shamslab/Desktop/CM_SpeechTask_Mach2_102422/Localization_IfspeechCrashes_lastrun.py',
...
practiceTrials = data.TrialHandler(nReps=0.0, method='sequential', 
